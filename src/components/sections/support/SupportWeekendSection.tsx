...
export default function SupportWeekendSection({ title, description, image }: SupportWeekendSectionProps) {
    return (
        <section className="bg-[#f7f7f7] py-14">
            <div className="mx-auto grid max-w-4xl items-center gap-8 px-6 lg:grid-cols-[1.15fr_0.85fr] lg:px-10">
                <div className="max-w-md">
                    ...
                    <p className="mt-4 text-sm leading-7 text-black/60 sm:text-base">{description}</p>
                </div>
