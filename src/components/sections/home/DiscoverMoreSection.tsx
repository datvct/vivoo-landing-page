  ...
  return (
    <section className="bg-[#f7f7f7] py-22">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
            ...
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`relative cursor-pointer pb-5 text-[20px] font-semibold transition-colors duration-200 sm:text-[22px] ${isActive ? "text-black" : "text-black/55 hover:text-black"}`}
                >
                  {tab.label}
                  <span
        ...
        <div
          key={activeTab.id}
          className={`mt-10 transition-all duration-500 ease-out ${isAnimating ? "translate-y-5 opacity-0" : "translate-y-0 opacity-100"}`}
        >
              ...
              (card) => (
                ...
                >
                  ...
                  <div className="px-6 py-6 text-center">
                    <h3 className="mx-auto max-w-sm text-[18px] leading-7 font-semibold text-black">
                      {card.title}
                    </h3>
