...
import type {
  ...
  SupportResourceCard,
  PhoneRegion,
} from "@/types/support-detail-types";
...
> = {
  unity: {
    ...
    subtitle:
      "Need help with your Unity product? Explore resources, contact support and phone options below.",
  ...
  "alta-video": {
    ...
    subtitle:
      "Find self-service resources and support channels for Alta Video.",
    heroImage: "/images/image1.avif",
  },
  "alta-access-control": {
    slug: "alta-access-control",
    title:
      "Alta Access Control support",
    subtitle:
      "Get support for your access control platform with quick links and contact channels.",
    heroImage: "/images/image1.avif",
  },
};
  ...
  [
    {
      ...
      description:
        "Find answers to product questions, how-to articles and troubleshooting resources.",
    ...
    },
    {
      ...
      description:
        "Join the community forum and ask questions, share ideas and connect with peers.",
      buttonLabel: "LEARN MORE",
      tone: "dark",
    },
    {
      ...
      description:
        "Take advantage of quick video lessons and product walkthroughs.",
      buttonLabel: "LEARN MORE",
      tone: "gray",
    },
  ];
  ...
  [
    {
      title: "WhatsApp",
      description:
        "Get in touch with the support team through WhatsApp for quick replies.",
    ...
    },
    {
      title: "Live Chat",
      description:
        "Use live chat during business hours for real-time help from an agent.",
    ...
    },
    {
      title: "SMS",
      description:
        "Send a text to the support team for quick contact and updates.",
    ...
    },
    {
      title: "Create a Case",
      description:
        "Open a new support case so the team can review your issue in detail.",
    ...
    items: [
      {
        ...
        phone: "Phone: +1 888 123 4567",
      },
      {
        country: "Canada (CA)",
        phone: "Phone: +1 888 234 5678",
      },
      {
        country: "Brazil (BR)",
        phone:
