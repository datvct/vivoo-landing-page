...
const blogPosts: BlogPost[] = [
    ...
    {
        title: "Retail loss prevention trends",
        category: "Retail",
        description:
    ...
    {
        title: "Warehouse protection strategies",
        category: "Logistics",
        description:
    ...
    {
        title: "Security leadership insights",
        category: "Leadership",
        description:
    ...
    {
        title: "Security camera placement tips",
        category: "Video Security",
        description:
    ...
    {
        title: "Cloud video management benefits",
        category: "Cloud",
        description:
    ...
    {
        title: "Security training for teams",
        category: "Training",
        description:
    ...
    {
        title: "Perimeter protection basics",
        category: "Perimeter",
        description:
    ...
    {
        title: "Building safety communications",
    ...
    {
        title: "Event investigation workflow",
        category: "Operations",
        description:
    ...
    return (
        <main className="min-h-screen bg-[#f7f7f5] text-black">
            <section className="mx-auto max-w-7xl px-6 py-12 lg:px-10 lg:py-16">
                ...
                <BlogPostsGrid posts={visiblePosts} currentPage={currentPage} />
                <BlogPagination currentPage={currentPage} totalPages={totalPages} onPageChange={goToPage} />
            </section>
        </main>
    );
}
