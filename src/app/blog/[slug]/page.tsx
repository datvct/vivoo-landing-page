...
> = {
  "martyns-law-in-education": {
    ...
    category: "Blog",
    title:
      "Martyn's Law for schools: Guide and checklist",
    subtitle:
...
export function generateStaticParams() {
  return Object.keys(blogDetails).map(
    (slug) => ({ slug })
  );
}
    ...
    <main className="min-h-screen text-black">
      ...
      {/* <section className="border-y border-black/5 bg-[#fbfbfa] py-7">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-10">
          <div className="flex flex-col flex-wrap items-center justify-center gap-x-10 gap-y-4 text-center text-sm text-black/55">
